...
CUDA_VISIBLE_DEVICES=0,1 llamafactory-cli train \
    ...
    --output_dir ./saves/Llama-3.1-8B-Instruct/AIRA_MoE_Math \
    --overwrite_cache \
...
#     --batch_size 8 \
#     --trust_remote_code \
#     --adapter_name_or_path ./saves/Llama-3.1-8B-Instruct/AIRA_MoE_Math \
#     --ddp_find_unused_parameters false 