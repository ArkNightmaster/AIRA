#!/bin/bash
# AIRA_MoE Standard Version - Generality Domain
# Enables CoLA collaborative adaptation + Activation-aware weighting
# Provides balanced performance and efficiency
...
CUDA_VISIBLE_DEVICES=2,3 llamafactory-cli train \
    ...
    --output_dir ./saves/Llama-3.1-8B-Instruct/AIRA_MoE_Standard_Generality \
    --overwrite_cache \
...
#     --batch_size 8 \
#     --trust_remote_code \
#     --adapter_name_or_path ./saves/Llama-3.1-8B-Instruct/AIRA_MoE_Standard_Generality \
#     --ddp_find_unused_parameters false 