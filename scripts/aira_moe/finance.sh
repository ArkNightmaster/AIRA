...
CUDA_VISIBLE_DEVICES=4,5 llamafactory-cli train \
    ...
    --output_dir ./saves/Llama-3.1-8B-Instruct/AIRA_MoE_Finance \
    --overwrite_cache \
...
#     --model_name_or_path /data/Llama-3.1-8B-Instruct \
#     --template llama3 \
#     --task fineval_test_None \
#     --lang en \
#     --n_shot 0 \
#     --batch_size 8 \
#     --trust_remote_code \
#     --adapter_name_or_path ./saves/Llama-3.1-8B-Instruct/AIRA_MoE_Finance \
#     --ddp_find_unused_parameters false 